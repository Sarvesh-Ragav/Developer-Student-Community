...
const initialEvents: Event[] = [
  ...
  },
  {
    ...
    detailedDescription: "A comprehensive developer conference bringing together the tech community. Featuring keynote speakers, technical workshops, hands-on sessions, and networking opportunities. Learn from industry experts and connect with fellow developers.",
    tag: "Conference",
    status: "completed",
  ...
  },
  {
    ...
    detailedDescription: "Learn and build with the latest web technologies in this hands-on workshop. Explore modern front-end frameworks, AI integration in web apps, and best practices for creating engaging user experiences. Perfect for both beginners and experienced developers.",
    tag: "Web Development",
    status: "completed",
  ...
  // Academic Year 2025-26 (Current Tenure)
  {
    ...
    detailedDescription: "A comprehensive aptitude and problem-solving competition designed to enhance your logical reasoning and analytical capabilities. Participate in challenging rounds that test your skills in mathematics, logic, and critical thinking.",
    tag: "Aptitude",
    status: "completed",
    date: "August 19, 2024",
    location: "Placement Seminar Hall",
  ...
  },
  {
    ...
    detailedDescription: "A tenure-spanning celebration featuring the official inauguration and a grand valedictory ceremony. We highlighted key initiatives, thanked contributors, and set the vision for the year ahead.",
    tag: "Ceremony",
    status: "completed",
