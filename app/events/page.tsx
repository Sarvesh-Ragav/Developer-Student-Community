...
const initialEvents: Event[] = [
  ...
  },
  {
    ...
    title: "Visualizing Web Development",
    description: "Hands-on web development event exploring the latest front-end and AI-integrated technologies.",
    detailedDescription: "Held on September 16, 2025, this web cloning challenge encouraged creativity as students rebuilt and redesigned websites based on surprise themes. Top performers earned ChatGPT Go subscriptions for innovation and execution. The event coincided with the DSC Inauguration & GDSC Valedictory, symbolizing a new era of student-led tech initiatives and leadership transition at SVCE.",
    tag: "Web Development",
    status: "completed",
